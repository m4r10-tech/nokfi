export default {
  ...
  share: {
    ...
    desc: 'Crea un enlace de solo lectura con tu libro de facturas y las estimaciones de impuestos por trimestre. Quien lo tenga puede verlo y descargarlo en Excel, sin cuenta. Caduca y puedes revocarlo cuando quieras.',
    createdOnce: 'Copia el enlace ahora: por seguridad no lo volveremos a mostrar.',
    labelPlaceholder: 'Para quién (p. ej. Gestoría López)',
    validity: 'Validez',
    days: '{n} días',
    create: 'Crear enlace',
    until: 'Válido hasta el {date}',
    lastOpened: 'abierto el {date}',
    neverOpened: 'sin abrir todavía',
    revoke: 'Revocar',
    confirmRevoke: '¿Revocar este enlace? Dejará de funcionar al momento.',
    revoked: 'Enlace revocado',
    tooMany: 'Ya tienes 5 enlaces activos. Revoca alguno para crear otro.',
    metaTitle: 'Libro compartido · Nokfi',
    readOnly: 'Solo lectura',
    expires: 'Enlace válido hasta el {date}',
    invoices: 'Facturas',
    taxesTitle: 'Impuestos por trimestre (estimación)',
    due: 'Plazo',
    estimateNote: 'Estimaciones calculadas por Nokfi a partir del libro; revísalas antes de presentar los modelos.',
    empty: 'No hay facturas en este año.',
